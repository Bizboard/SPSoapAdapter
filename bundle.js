...
System.register("SharePoint.js", ["npm:eventemitter3@1.1.0.js", "github:Bizboard/arva-utils@master/BlobHelper.js"], function($__export) {
  "use strict";
      ...
      SharePoint = function($__super) {
        function SharePoint() {
          ...
          if (DEBUG_WORKER) {
            ...
            var url = window.URL.createObjectURL(SharePointWorkerSourcecodeBlob);
